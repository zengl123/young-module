...
import com.young.mapper.UacUserTokenMapper;
...
import com.young.properties.Oauth2ClientProperties;
 ...
 * @Author:zengling
 * @钉钉:17363645521
 * @CreateDate:2019/5/15 9:23
 * @UpdateUser:
 * @UpdateDate:2019/5/15 9:23
 * @UpdateRemark:
 * @Version:
 */
@Service
@Transactional(rollbackFor = Exception.class)
public class UacUserTokenServiceImpl extends BaseService<UacUserToken> implements IUacUserTokenService {
    @Resource
    ...
    @Value("${young.auth.refresh-token-url}")
