 ...
 * @Author:zengling
 * @钉钉:17363645521
 * @CreateDate:2019/5/15 15:26
 * @UpdateUser:
 * @UpdateDate:2019/5/15 15:26
 * @UpdateRemark:
 * @Version:
 */
...
public class RedisKeyUtil {
     ...
     */
    private static final String RESET_PWD_TOKEN_KEY = "young:restPwd";
    private static final String ACTIVE_USER = "young:activeUser";
    private static final String SEND_SMS_COUNT = "young:sms:count";
    private static final String SEND_EMAIL_CODE = "young:email:code";
    private static final String ACCESS_TOKEN = "young:token:accessToken";
    private static final String UPLOAD_FILE_SIZE = "young:file:upload_file_size";
