 ...
 * @UpdateUser:
 * @UpdateDate:2019/5/15 15:04
 * @UpdateRemark:
 * @Version:
 */
@NoArgsConstructor(access = AccessLevel.PRIVATE)
public class AliyunMqTopicConstant {
    /**
    ...
    private static String buildOpcConsumerTopics() {
        ...
        addDeleteMessageTag(topicObjList);
    ...
    private static void addDeleteMessageTag(List<TopicObj> topicObjList) {
