...
import com.young.service.IdGenerator;
 ...
 * @Author:zengling
 * @钉钉:17363645521
 * @CreateDate:2019/5/15 12:47
 * @UpdateUser:
 * @UpdateDate:2019/5/15 12:47
 * @UpdateRemark:
 * @Version:
 */
public class UniqueIdGenerator implements IdGenerator {
    ...
    private synchronized long genUniqueId() {
        ...
        // 进行移位操作生成int64的唯一ID
        return ((current - START_TIME) << TIMESTAMP_LEFT_SHIFT) | (this.appHostId << APP_HOST_ID_SHIFT) | sequence;
    }
